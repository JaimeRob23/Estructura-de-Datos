...
public class AudioFileRecord {
    ...
    public ArregloNumerico arreglo1;
    ...
    public void leerAudio() {
        try {
            ...
            arreglo1=new ArregloNumerico(buffer2.length);
            arreglo1.recibirBuffer(buffer2);
    ...
    public void EscribirAudio() {
        try {
            ...
            Object[] arregloNuevo= arreglo1.leerArreglo();

            for(int recorredorArregloNuevo=0;recorredorArregloNuevo<arregloNuevo.length;recorredorArregloNuevo++){
                buffer2[recorredorArregloNuevo]=(double) arregloNuevo[recorredorArregloNuevo];
            }
